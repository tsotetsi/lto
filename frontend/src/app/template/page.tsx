...
export default function TemplateEditor() {
  ...
  return (
    <main className="flex h-screen w-screen overflow-hidden bg-theme-primary text-theme-primary font-sans transition-colors duration-200">
            ...
            <div className="flex items-center gap-3">
              ...
              {isCompiling && (
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-[var(--accent-blue)] rounded-full animate-ping"></div>
      ...
      <div className="w-1/2 bg-theme-editor flex flex-col">
        {pdfUrl ? (
          <iframe 
            key={pdfUrl}
          ...
          <div className="flex flex-col items-center justify-center h-full text-theme-muted gap-4">
            <div className="w-12 h-12 border-4 border-theme-primary border-t-[var(--accent-blue)] rounded-full animate-spin"></div>
            <p className="text-sm font-medium">
              {selectedTemplate ? 'Booting PDF Engine...' : 'Select a template to preview'}
            </p>
          </div>
        )}
      </div>
